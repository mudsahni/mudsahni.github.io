import BrainPlayingChess from './images/brain_playing_chess.jpg'

const theresSomeoneInMyHead = {
    title: "There's someone in my head and it's not me",
    date: "2020/01/01",
    readTime: "7 minutes read",
    type: "Thoughts",
    image: BrainPlayingChess,
    link: 'theresSomeoneInMyHead',
    tags: [{ content: "neuroscience" }, { content: "incognito" }, { content: "david eagleman" }, { content: "free will" }, { content: "consciousness" }, { content: "brain" }],
    abstract: <p> I recently read Incognito by David Eagleman, and now my brain has written an 'article' about it. I really can't be blamed for writing this as it's very apparent that
    ...
    content: <div>
        ...
        <p>
            If I have learned anything so far, it is that we are not much in control of anything we are doing!
        ...
        <p className="post-subheader">We are only getting the headlines</p>
        <p>
        ...
        <p className="post-subheader">There are a lot of voices in our heads</p>
        ...
        <p className="post-subheader">Does redundancy drives optimisation?</p>
        ...
        <p className="post-subheader">Are we in there somewhere?</p>
        ...
        <p>
            And not just in the context of brain damage, what about nurture <em>and</em> nature? Prison populations across the world are dominated by people with one particular gene which makes them extraordinarily more violent&mdash;the Y chromosome.
        ...
        <p>We are after all composed of atoms and molecules of the same chemical components found every where in the universe.
            Are we just a tightly packed collection of atoms bouncing around and off other atoms, giving rise to macro effects because of our interaction or lack of interaction with other stimuli composed of the same components?</p>
        <p>
        ...
        <p>Anyway, I could go on and on about these conflicting questions. I think this was helpful. I enjoyed writing about it. I think it's helped me augment what I have learned so far with some of <em>my very own thoughts</em>! Ha! Though I suspect I have primarily only ended up summarising the book.
                    ...
                    The answer, unfortunately, is fairly obvious. As soon as you try this activity you will realise that "if our brains were simple enough to be understood, we wouldn't be smart enough to understand them".</p>
    </div>

}

export default theresSomeoneInMyHead